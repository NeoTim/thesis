...
this.allowedSections=["mycontent","hubtivity","followers","following","fanmail","email","bio"];
this.bindEvents();
...
("undefined"!=typeof content_items)?content_items.activate("latest_items"):false;
this.showLoadMoreButton();
}
jq("div.categoryTeaser").each(function(){
var _72d=jq(this).find("img"),_72e=_72d.height(),_72f=_72d.width(),_730=300,_731=240,_732=_72e/_72f,_733=_731/_730,_734=_730,_735=_731;
if(_732<_733){
_734=_72f/_72e*_731;
}else{
if(_732>_733){
...
_72d.css({"position":"relative","height":_735+"px","width":_734+"px"});
var _736=((_72d.height()-_731)*0.4)*-1,_737=((_72d.width()-_730)/2)*-1;
_72d.css({"top":_736+"px","left":_737+"px"});
});
};
ProfileManager.prototype.showLoadMoreButton=function(){
var _738=this.containerSectionDiv.find("> div:visible");
switch(this.currentSection){
case "mycontent":
var _739=jq(".content_nav ul#tabs li.active");
if(_739.length>0){
var _73a=_739.attr("id").replace(/_items_item/,"");
if((_73a=="hot"&&this.profileContainer.data("moreHot")==="1")||(_73a=="latest"&&this.profileContainer.data("moreLatest")==="1")||(_73a=="best"&&this.profileContainer.data("moreBest")==="1")){
if(!_738.find("div.content_items:visible").first().data("no_content")){
...
break;
case "following":
if(!_738.find("#following_people").data("no_content")||!_738.find("#following_topics").data("no_content")){
_738.append(this.loadMoreBtn);
this.loadMoreBtn.show();
}else{
this.loadMoreBtn.hide();
}
break;
default:
if(this.currentSection!="hubtivity"){
var _73b=this.getDivSection(this.currentSection);
if(!_73b.data("no_content")){
_738.append(this.loadMoreBtn);
this.loadMoreBtn.show();
}else{
this.loadMoreBtn.hide();
...
ProfileManager.prototype.loadSectionByHashTag=function(_73c){
if(_73c){
var _73d=_73c.replace("#",""),_73e="latest_items";
if(_73d.match(/^slide/)){
jq("ul.profile_links > li.recent_images").trigger("click");
}else{
if(_73d.match(/^mycontent_.*_latest$/)||_73d.match(/^mycontent_.*_hot$/)||_73d.match(/^mycontent_.*_best$/)){
var _73f=_73d.replace(/^mycontent_|_[a-z]+$/g,""),tab=_73d.match(/[a-z]+$/),_740=jq("ul.filter_by_topic li");
for(var i=0,l=_740.length;i<l;i++){
if(jq(_740[i]).attr("data-hash")==_73f){
_73e=tab+"_items";
("undefined"!=typeof content_items)?content_items.activate(_73e):false;
jq(_740[i]).trigger("click");
break;
}
}
}else{
if(this.isValidSection(_73d)){
jq("a[href=#"+this.currentSection+"]").parent().removeClass("active");
this.currentSection=_73d;
...
ProfileManager.prototype.isValidSection=function(_741){
var _742=false;
for(i in this.allowedSections){
if(this.allowedSections[i]==_741){
_742=true;
break;
}
}
...
var _743=jq(window),_744=jq("#footer_wrap"),pos=_743.scrollTop(),_745=jq("#profile_header"),_746=_745.offset().top,_747=jq(window).scrollTop()>=(jq(document).height()-jq(window).height()-30),_748=jq("#profile_content_container > div:visible"),_749=(_748.length>0)?_748.attr("id").replace(/section_/,""):"",_74a=[],_74b=jq(".content_nav ul#tabs li.active"),_74c="";
if(_749=="mycontent"){
if(_74b.length==0){
return;
}
_74c=_74b.attr("id").replace(/_items_item/,"");
}
if(_749=="following"){
_74a.push(jq("#following_people"));
_74a.push(jq("#following_topics"));
}else{
if(this.getDivSection(_749)){
_74a.push(this.getDivSection(_749));
}
}
_74a.each(jq.proxy(function(_74d){
if((_74c=="hot"&&this.profileContainer.data("moreHot")==="0")||(_74c=="latest"&&this.profileContainer.data("moreLatest")==="0")||(_74c=="best"&&this.profileContainer.data("moreBest")==="0")){
return;
}
if(!_74d.data("no_content")){
if(_74d.data("loading")){
return;
}
if((_743.scrollTop()+_743.height())>=(jq(document).height()-1)){
setTimeout(jQuery.proxy(function(){
this.loadContent(_74d,_749,_74c);
},this),300);
}
}
},this));
};
ProfileManager.prototype.loadContent=function(_74e,_74f,_750){
var _751=jq(".newprofile #show_only").data("categoryId")||"all";
var page=_74e.data("next")||2;
this.loadMoreBtn.hide();
if(jq("#spinner_loading").length>0){
_752=jq("#spinner_loading");
}else{
var _753=jq("#footer_wrap").height();
var _752=jq("<div/>",{"id":"spinner_loading",}).html(jq(this.spinnerDiv));
}
_752.show();
_74e.parent().append(_752);
_74e.parent().find("#spinner_loading > img.spinner").show();
if(_74f=="following"){
_74f=_74e.attr("id");
}
_74e.data("loading",true);
jq.get(this.profileContainer.data("loadMoreUrl"),{section:_74f,userId:this.userId,activeTab:_750,categoryId:_751,page:page,ajax:1},jq.proxy(function(data,_754,xhr){
_752.hide();
if(_74f=="fanmail"){
var _755=jq(data.render);
jq.each(_755,function(){
...
if(_74e.find("#"+id).length===0){
if(_74f=="mycontent"){
_74e.find("ul").append(val);
}else{
_74e.append(val);
}
}
...
_74e.data("next",page+1);
this.loadMoreBtn.show();
}else{
jq(document).data("no_content_all",true);
_74e.data("no_content",true);
}
jq(document).trigger("update_follow_buttons");
updateFollowButtons();
_74e.data("loading",false);
},this),"json");
};
ProfileManager.prototype.dismissSimilarUser=function(self){
var _756=jq(this).parent(),_757=_756.attr("id").replace(/similar_user_/,""),_758=jq("div.similar_users_box"),_759=_758.find(".last_similar_user");
if(_759.length===0){
firstUserId=_758.find(".similar_user").last().attr("id").replace(/similar_user_/,"");
}else{
firstUserId=_759.attr("id").replace(/similar_user_/,"");
}
jq.ajax({url:"/xml/profile/similar_users.php",type:"POST",dataType:"json",data:{profileUserId:self.userId,userId:_757,firstUserId:firstUserId,action:"dismiss"},success:jq.proxy(function(data){
_756.fadeOut("slow",function(){
if(_756.parent().find(".similar_user:visible").length==0){
_756.parent().parent().fadeOut("slow",function(){
jq(this).remove();
});
}
if(data.render!=""){
_758.find(".last_similar_user").each(function(){
jq(this).removeClass("last_similar_user");
});
_756.replaceWith(data.render);
jq("#"+jq(data.render).attr("id")).addClass("last_similar_user");
_758.fadeIn();
jq(document).trigger("update_follow_buttons");
updateFollowButtons();
if(_758.find(".similar_user").length<3){
...
var _75a=jq("div.similar_users_box"),_75b=_75a.find(".similar_user").last().attr("id").replace(/similar_user_/,"");
jq.ajax({url:"/xml/profile/similar_users.php",type:"POST",dataType:"json",data:{profileUserId:this.userId,firstUserId:_75b},success:jq.proxy(function(data){
if(data.render!=""){
_75a.find("div.content_box_i").append(data.render);
_75a.fadeIn();
jq(document).trigger("update_follow_buttons");
updateFollowButtons();
}
if(_75a.find(".similar_user").length<3){
...
var _75c=jq("div.similar_users_box"),_75d=_75c.find(".similar_user").length;
if(data.render!=""){
_75c.find("div.content_box_i").append(data.render);
_75c.fadeIn();
jq(document).trigger("update_follow_buttons");
updateFollowButtons();
if(_75c.find(".similar_user").length<3&&data.more){
this.loadSingleSimilarUser();
}
}else{
if(data.more){
...
var _75e=new RegExp(window.location.hash.replace(/slide|#/g,""),"i");
jq.each(jq(".slideshow img"),function(){
if(_75e.test(jq(this).attr("src"))){
...
var _75f=jq("#profile_content_container > div:visible"),_760=(_75f.length>0)?_75f.attr("id").replace(/section_/,""):"",_761=[],_762=jq(".content_nav ul#tabs li.active"),_763="";
if(_760=="mycontent"){
if(_762.length==0){
return;
}
_763=_762.attr("id").replace(/_items_item/,"");
_761.push(_75f.find("div.content_items:visible").first());
}else{
if(_760=="followers"){
_761.push(_75f.find("div").first());
}else{
if(_760=="following"){
_761.push(jq("#following_people"));
_761.push(jq("#following_topics"));
}else{
if(_760=="fanmail"){
_761.push(_75f.find("#fanmail_content"));
}
}
}
}
_761.each(function(_764){
if(!_764.data("no_content")){
if(_764.data("loading")){
return;
}
self.loadContent(_764,_760,_763);
}else{
...
var _765=jq(this).closest("div");
e.preventDefault();
_765.html(jq("img.spinner").first());
_765.hide();
jq("#biography").show();
});
...
var _766=jq(this).find("a").text();
jq.each(jq(this).parent().find("li"),function(){
jq(this).removeClass("active");
});
self.loadSection(_766);
});
var _767=jq(".newprofile div.content_nav ul.filter_by_topic"),_768=jq(".newprofile #show_only"),_769="#section_mycontent .content_items:visible",_76a=jq("ul.filter_by_topic li"),_76b=false;
_768.click(function(){
if(!_76b){
_767.attr("tabindex",-1);
setTimeout(function(){
_767.focus();
},0);
if(_767.is(":visible")){
_767.hide();
_768.find("span").removeClass("active");
}else{
_767.show();
_768.find("span").addClass("active");
}
var _76c=_767.offset().left,_76d=_768.offset().left,_76e=(_76c-_76d)+11;
_767.css("right",parseFloat(_767.css("right"))+_76e+"px");
_76b=false;
}
});
_767.bind("blur",function(e){
_76b=true;
jq(this).hide();
_768.find("span").removeClass("active");
setTimeout(function(){
...
_76a.click(function(){
var _76f=jq(this).attr("id").replace(/category_/,""),_770=jq(".content_nav ul#tabs li.active"),_771=jq(".content_nav ul#tabs li.active").attr("id").replace(/_items_item/,""),_772=jq(this).text();
_770.data("categoryId",_76f);
jq(_769).find("ul").html(jq(self.spinnerDiv));
jq(_769).data("loading",true);
loadCategoryContent("mycontent",_76f,_771,function(res){
var _773=jq(_769).find("ul");
_773.find("img.spinner").hide();
jq.each(res.render,function(id,val){
if(_773.find("#"+id).length===0){
_773.append(val);
}
});
jq(_769).removeData("next");
if(res.more){
jq(_769).data("no_content",false);
jq(document).data("no_content_all",false);
}else{
jq(document).data("no_content_all",true);
jq(_769).data("no_content",true);
}
_768.data("categoryId",_76f);
_768.data(getUrlHashTagVersion(_772),_76f);
_768.html("<span></span><strong>Show</strong>: "+_772);
jq(_769).data("loading",false);
loadHashTag(_771);
self.showLoadMoreButton();
});
_768.attr("tabindex",-1);
_768.focus();
_767.hide();
_768.find("span").removeClass("active");
});
};
ProfileManager.prototype.openFancyBox=function(_774,_775){
var el=jq(_774);
jq.fancybox({"href":_774,onStart:function(){
el.show();
},onClosed:function(){
el.hide();
...
ProfileManager.prototype.getDivSection=function(_776){
var _777,_778=jq("#section_"+_776);
if(_776=="mycontent"){
_777=_778.find("div.content_items:visible").first();
}else{
if(_776=="followers"){
_777=_778.find("div").first();
}else{
if(_776=="fanmail"){
_777=_778.find("#fanmail_content");
}
}
}
return _777;
};
ProfileManager.prototype.loadSection=function(_779,_77a){
this.currentSection=_779.replace(/\s/,"").toLowerCase();
var _77b="section_"+this.currentSection,isCr=typeof cr,_77c=jq("#profile_content_container"),_77d=_77c.offset().top,_77e=jq(this.spinnerDiv);
var _77f=jq("a[href=#"+this.currentSection+"]");
if(_77f.length>0){
jq("a[href=#"+this.currentSection+"]").parent().addClass("active");
}
if(_77b!="section_mycontent"&&jq("#teaser").length>0&&isCr!="undefined"){
cr.pause();
}
...
_781.append(el.render).appendTo("#profile_content_container");
if(!el.more&&this.currentSection!="hubtivity"){
if(this.currentSection==="following"){
_781.find("#"+el.section).data("no_content",true);
}else{
...
jq(document).trigger("update_follow_buttons");
updateFollowButtons();
if(_77b=="section_fanmail"){
var _783=jq("#email_to_user");
if(_783.length>0){
...
_783.hide();
_783.find("#success_message_email").hide();
_783.find("#email").show();
_783.find("h3").show();
},onComplete:function(e){
_783.css("overflow-x","hidden");
}});
...
var _784=jq("#success_message_email");
_784.html(messaging);
_784.siblings("#email").fadeOut("slow",function(){
...
var _785=$("fanmailadd");
Element.update(_785,req.responseText);
};
...
this.showLoadMoreButton();
(_77a!=undefined)?_77a.call(this):false;
},this));
}
};
